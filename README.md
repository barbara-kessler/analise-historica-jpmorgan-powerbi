...
## 🛠️ Competências Técnicas e Ferramentas Utilizadas

* **Power BI Desktop:** Construção integral do ecossistema de análise (da ingestão de dados brutos à interface interativa).
* **Modelagem de Dados e ETL:** Tratamento de dados históricos e estruturação de tabela de Calendário para suporte analítico.
* **Linguagem DAX:** Criação de métricas de Inteligência de Tempo (*Time Intelligence*) e indicadores dinâmicos de volatilidade.
* **Design de Dashboards (UX/UI):** Aplicação de princípios de Gestalt para alinhamento, agrupamento lógico de visuais e jornada de leitura fluida.
...
Para mapear a saúde financeira e o comportamento dos ativos da JPMorgan, este dashboard foi estruturado a partir de seis visões complementares, organizadas seguindo a lógica natural de leitura do usuário:
...
* **Entender as conexões e filtros:** Aprender como os segmentadores influenciam os gráficos e como trabalhar com os contextos de filtro para que as análises históricas funcionassem perfeitamente sem quebrar.
* **Praticar a leitura analítica:** Treinar o olhar técnico para identificar anomalias, grandes correções e picos de volume, traduzindo o comportamento visual em respostas reais de negócio.
* **Organização e Storytelling:** Criar um layout limpo e corporativo, combinando visuais mensais e de longo prazo sem poluir a tela, garantindo uma leitura fluida e focada em UX/UI para o usuário.
